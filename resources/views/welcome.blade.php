						...
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>Faites votre carte grise <br>en ligne en 10 minutes</h1>
									<p><h4>Service en ligne d’immatriculation habilité par l’Etat.</h4></p>
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-6 no-padding exclusive-left">
				<div class="row clock_sec clockdiv" id="clockdiv">
					<div class="col-lg-12">
						<h1>VOTRE CARTE GRISE EN 3 ÉTAPES</h1>
				...
				<a href="" class="primary-btn">Commancer</a>
			</div>
				...
				<div class="active-exclusive-product-slider">
					...
					<div class="single-exclusive-slider">
						...
						<div class="product-details">
							...
							<h4>Validez vos formulaires</h4>			
						</div>
					</div>
					<div class="single-exclusive-slider">
						<img class="img-fluid" src="img/product/e-p3.png" alt="">
						<div class="product-details">
							<h4>La commande chez vous</h4>
						</div>
					</div>
				</div>
			</div>
